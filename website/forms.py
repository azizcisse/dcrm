...
class SignUpForm(UserCreationForm):
    email = forms.EmailField(label="", max_length="120", widget=forms.TextInput(attr={'class':'form-control', 'placeholder':'Adresse email'}))
    first_name = forms.CharField(label="", max_length="100", widget=forms.TextInput(attr={'class':'form-control', 'placeholder':'Votre Prénom'}))
    last_name = forms.CharField(label="", max_length="100", widget=forms.TextInput(attr={'class':'form-control', 'placeholder':'Votre Nom'}))
